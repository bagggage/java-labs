...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        for (int i = 0; i < this.ownedRepositories.size(); ++i) {
            if (this.ownedRepositories.get(i).getId() != other.ownedRepositories.get(i).getId()) return false;
        }

        for (int i = 0; i < this.contributing.size(); ++i) {
            if (this.contributing.get(i).getId() != other.contributing.get(i).getId()) return false;
        }
